...
\begin{figure}[h]
    ...
    The plot shows the orbit of the particle with different time increments.
    $h$ is almost halved at each step, from $h = \num{2e-3}$ to $h = \num{1e-5}$.
    The orbits are almost indistinguishable and smaller values of h appears to
    be converging to the same orbit, showing that the numerical integration is
    stable.}
