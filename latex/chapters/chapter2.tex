...
All possible scenarios are summarized in Table \ref{cap2:tab:scenarios}.

\begin{table}[h]
    \centering
    \begin{tabular}{cccc}
        $\hat \ell$     & $\mathcal E$                              & $\hat r$                    & Scenario \\
        $[0,~\sqrt{3}]$ & $\left[0,~\frac{1}{2} \right)$            & $\left(1,~  \infty \right)$ & depends on the sign\\
        $[0,~\sqrt{3}]$ & $\left[-\frac{1}{2},~0 \right)$           & $\left(1,~     r_e \right)$ & infall \\
        $(\sqrt{3},~2]$ & $\left[0,~\frac{1}{2} \right)$            & $\left(1,~  \infty \right)$ & depends on the sign \\
        ...
        $(\sqrt{3},~2]$ & $\left[-\frac{1}{2},~V_{\rm min} \right]$ & $\left(1,~     r_e \right)$ & infall \\
        $(2, \infty)$   & $\left[V_{\rm max},~\frac{1}{2} \right)$  & $\left(1,~  \infty \right)$ & depends on the sign \\
        ...
        $(2, \infty)$   & $\left[-\frac{1}{2},~V_{\rm min} \right]$ & $\left(1,~     r_e \right)$ & infall \\
    \end{tabular}
