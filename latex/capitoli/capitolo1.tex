...
We can defined the coserved quantities $e$ and $l$ in the same way, using the
four-velocity
...
When working with light we define the four-velocity using the
\textit{affine parameter} $\lambda$.
...
\ref{ca1:fig:W_eff_orbits}), but most importantly in this case, $r_1$ cuts the
trajectory in half.
